...
@ManagedBean (name="keycodeBankManageLoadTabbedPaneHandler")
@ViewScoped
public class KeycodeBankManageLoadTabbedPaneHandler implements Serializable {
	/**
	 * 
	 */
	...
	public KeycodeBankManageLoadTabbedPaneHandler() {
		index = SEARCH_INDEX;
	}
