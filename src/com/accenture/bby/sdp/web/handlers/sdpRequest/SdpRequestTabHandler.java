...
public class SdpRequestTabHandler implements Serializable {
	...
	public boolean isOperationsTabCurrent() { return index == OPERATION_INDEX; }
	public boolean isFormTabCurrent() { return index == FORM_INDEX; }
	public boolean isFormSubmittedTabCurrent() { return index == SUBMITTED_INDEX; }
	
	public void displayOperationsTab() { index = OPERATION_INDEX; }
	public void displayFormTab() { index = FORM_INDEX; }	
	public void displayFormSubmittedTab() { index = SUBMITTED_INDEX; }	
